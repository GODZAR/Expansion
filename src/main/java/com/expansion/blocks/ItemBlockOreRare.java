...
public class ItemBlockOreRare extends ItemBlock {

	public ItemBlockOreRare(Block block) {
		super(block);
			}
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean Adva){
		...
		list.add(EnumChatFormatting.WHITE + "Usage: " + EnumChatFormatting.WHITE + "Smelthing");
	}
}
